...
import { GUILDS, GUILD_LEVEL_CONFIG } from '@/data/config';
import { getGuildLevelConfig, getRivalGuilds, getGuildStations } from '@/engine/guildSystem';
          ...
          return (
            ...
            >
              ...
              <div className="flex justify-between text-xs text-gray-500 mb-2">
                ...
                <span>罚金 x{levelConfig.penaltyMultiplier.toFixed(2)}</span>
